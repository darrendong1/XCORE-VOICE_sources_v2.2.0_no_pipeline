...
#define appconfflash_PORT              9
#define appconfMICARRAY_PORT           10
#define appconfUSB_AUDIO_PORT_USER     11
...
#define appconfPIPELINE_BYPASS 1
...
#define appconfI2S_IO_CORE                      1 //2 /* Must be kept off core 0 with the RTOS tick ISR */
//#define appconfI2C_IO_CORE                      //5 /* Must be kept off core 0 with the RTOS tick ISR */
//#define appconfPDM_MIC_INTERRUPT_CORE           4 /* Must be kept off I/O cores. Best kept off core 0 with the tick ISR. */
#define appconfI2S_INTERRUPT_CORE               0 /* Must be kept off I/O cores. Best kept off core 0 with the tick ISR. */
